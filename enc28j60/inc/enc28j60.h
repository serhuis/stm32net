...
#define ENC28J60_RES_PORT		GPIOB
#define ENC28J60_RES_PIN		GPIO_Pin_11
...
#define enc28j60_disable()		{GPIO_ResetBits(ENC28J60_RES_PORT, ENC28J60_RES_PIN);}
#define enc28j60_enable()			{GPIO_SetBits(ENC28J60_RES_PORT, ENC28J60_RES_PIN);}
// Init ENC28J60
