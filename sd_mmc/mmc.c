...
//	GPIO_PinAFConfig(GPIO_SPI_SD, GPIO_PinSource3,GPIO_AF_SPI1);
//	GPIO_PinAFConfig(GPIO_SPI_SD, GPIO_PinSource4,GPIO_AF_SPI1);
//	GPIO_PinAFConfig(GPIO_SPI_SD, GPIO_PinSource5,GPIO_AF_SPI1);
...
// ctrl card
DRESULT MMC_disk_ioctl(BYTE drive, BYTE command, void *buf)
{
